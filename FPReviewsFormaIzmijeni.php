...
<?php
    ...
    $sve = $veza->query("select naslov, tekst from reviews where id=".$id);
    if (!$sve) {
...
echo('<form enctype="multipart/form-data" method="post" action="izmijeniRecenziju.php?id='.$id.'" name="changer">');
?>
